...
<body>
	...
	<div class="span10" align="left">
		...
		<div>
			...
			<h5>Enter the new Email ID that you wish to associate with your
				Flipkart account.</h5>
			<s:form action="updateEmail" method="post" validate="true">
				<table theme="simple">
					<tr>
					...
					<tr>
						...
						<td><s:textfield name="updated_email" theme="simple" /></td>
					</tr>
